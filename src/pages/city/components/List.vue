...
<div class="list" ref="wrapper">
  ...
  <div class="area">
    ...
    <div class="button-list">
       <div class="button-wrapper" v-for="city of hot" :key="city.id" @click="handleHotCity(city.name)">
  ...
  <div class="area" v-for="(item, key) of cities" :key="key" :ref="key">
    ...
    <div class="item-list">
      <div class="item border-bottom" v-for="city of   item" :key="city.id" @click="handleHotCity(city.name)" >
        {{city.name}}
      </div>
    </div>
  </div>
